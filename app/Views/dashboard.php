...
<body>
    ...
    <div class="header">
        ...
        <div class="header__right">
            ...
            <a href="/logout">
                <button type="submit" class="btn"><span class="material-icons"> expand_more </span></button>
            </a>
        ...
        <div class="feed">
            ...
            <div class="messageSender">
                <div class="messageSender__top">
                    ...
                    <form action="<?= base_url('create') ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input name="post" class="messageSender__input" placeholder="What's on your mind?" type="text" />
                </div>
                <div class="messageSender__bottom">
                    <div class="messageSender__option" style="max-width: 250px">
                    ...
                    <button type="submit" class="btn" style="background-color: transparent;">Post</button>
                </div>
                </form>
            ...
            foreach ($post as $key => $p) : ?>
                ...
                <div class="post">
                    ...
                    <div class="post__image">
                        <?php if ($p['img'] != null) { ?>
                            <img width="5px" src="<?= base_url() . "/uploads/berkas/" . $p['img']; ?>" />
                        <?php } ?>
                    </div>
                    ...
                    <form action="<?php echo site_url('createlike') ?>" method="POST">
                        ...
                        <div class="post__options">
                            <div class="post__option">
                                ...
                                ?>
                                    <button type="submit" class="btn btn-sm" style="background-color: transparent;">Like</button>
                                <?php } ?>
                            </div>
                    </form>
